#ifndef CAR_KIN_LINEARIZER_H
#define CAR_KIN_LINEARIZER_H

#include "ros/ros.h"
#include "std_msgs/Float64MultiArray.h"
#include "nav_msgs/Odometry.h"

class CarKinLinearizer
{
public:
    /**
     * @brief Construct a new CarKinLinearizer object.
     * 
     ...
     */
    CarKinLinearizer(ros::NodeHandle n);
